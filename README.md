...
<ul>**Crossentropy loss**<br>*(Lower the better)*
<li>loss(train_loss): 2.12</li>
<li>val_loss: 3.39</li>
**BLEU Scores on Validation data**<br>*(Higher the better)*
<li>BLEU-1: 0.58</li>
<li>BLEU-2: 0.33</li>
<li>BLEU-3: 0.23</li>
<li>BLEU-4: 0.11</li>
</ul> |<ul>**k = 3**<br>
<br>**BLEU Scores on Validation data**<br>*(Higher the better)*
<li>BLEU-1: 0.59</li>
<li>BLEU-2: 0.34</li>
<li>BLEU-3: 0.24</li>
<li>BLEU-4: 0.12</li></ul> |
| **InceptionV3 + GRU** <ul>
<li>Epochs = 9</li>
<li>Batch Size = 64</li>
<li>Optimizer = Adam</li>
...
<li>BLEU-2: 0.35</li>
<li>BLEU-3: 0.25</li>
<li>BLEU-4: 0.13</li></ul> |
| **VGG16 + AlternativeLSTM** <ul>
<li>Epochs = 18</li>
<li>Batch Size = 64</li>
<li>Optimizer = Adam</li>
</ul> |
<ul>**Crossentropy loss**<br>*(Lower the better)*
<li>loss(train_loss): 2.13</li>
<li>val_loss: 3.21</li>
**BLEU Scores on Validation data**<br>*(Higher the better)*
<li>BLEU-1: 0.57</li>
<li>BLEU-2: 0.33</li>
